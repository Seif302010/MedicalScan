CREATE DATABASE medical_scan
  ON 
  (NAME = YourDataFileName, FILENAME = 'C:\medical_scan.mdf', SIZE = 8MB, MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
  LOG ON 
  (NAME = YourLogFileName, FILENAME = 'C:\medical_scan.ldf', SIZE = 8MB, MAXSIZE = UNLIMITED, FILEGROWTH = 5MB);
